      ...
      >
        ...
        {sessionStartTime && (
          <span className="font-mono text-dim" style={{ fontSize: 9 }}>
            {formatTime(new Date(sessionStartTime))}
          </span>
        )}
      </div>
      ...
      <div style={{ padding: "14px 16px", flex: 1, display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div>
          <div className="flex items-end justify-between" style={{ marginBottom: 8 }}>
            <div>
              <div className="font-mono text-dim uppercase" style={{ fontSize: 7, letterSpacing: "0.09em", marginBottom: 3 }}>
                Production Target
              </div>
              <div style={{ lineHeight: 1 }}>
                <span
                  ...
                  style={{ fontSize: 28, animation: "countUp 0.3s ease-out", letterSpacing: "-0.02em" }}
                >
                  {pieceCount}
                </span>
                <span className="font-mono text-text-muted" style={{ fontSize: 13, marginLeft: 4 }}>
                  / {target}
                </span>
              </div>
            </div>
            <div
              ...
              style={{
                fontSize: 20,
                color: pct >= 100 ? "#22C55E" : pct >= 75 ? "#3B82F6" : "#E8ECF1",
              }}
            >
              {pct.toFixed(0)}%
            </div>
          ...
          <div
            ...
            style={{ height: 5, background: "#243044" }}
          >
            <div
              ...
              style={{
                width: `${pct}%`,
                background: barColor,
                boxShadow: pct >= 100 ? "0 0 10px rgba(34,197,94,0.5)" : "none",
              }}
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {[
            ...
            <div key={l} style={{ background: "#0B1017", border: "1px solid #243044", borderRadius: 7, padding: "8px 10px" }}>
              ...
              <div className="font-mono font-semibold" style={{ fontSize: 11, color: c }}>
                {v}
              </div>
            </div>
          ))}
        ...
        {remaining > 0 ? (
          ...
          <div
            className="text-center rounded-lg font-mono font-bold text-success"
            style={{
