...
export function CycleTimeChart() {
  ...
  const data = cycleHistory.slice(-30).map((r) => ({
    piece: `#${r.pieceNumber}`,
    cycleTime: r.durationSeconds,
  }));
      ...
      >
        <div>
          ...
          <div
            ...
            style={{ fontSize: 9 }}
          >
            Seconds per piece · target ≤ {CYCLE_TIME.TARGET_SECONDS}s
          </div>
        </div>
        ...
        <div className="flex flex-col items-end gap-1">
          <div className="flex items-center gap-1.5">
            ...
            />
            <span className="font-mono text-success" style={{ fontSize: 8 }}>
              Target
            </span>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            ...
            />
            <span className="font-mono text-warning" style={{ fontSize: 8 }}>
              Warn
            </span>
          </div>
        </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Tooltip
                ...
                formatter={(value) => [`${value ?? 0}s`, "Cycle"]}
                isAnimationActive={false}
              />

              <ReferenceLine
                y={CYCLE_TIME.TARGET_SECONDS}
                stroke="#22C55E"
                strokeDasharray="4 3"
                strokeOpacity={0.5}
                strokeWidth={1}
