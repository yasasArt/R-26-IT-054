...
export type OperationType = "COLLAR" | "POCKET" | "SLEEVE";
export type CycleTimeStatus = "WITHIN_ESTIMATE" | "OVER_ESTIMATE" | "NOT_CONFIGURED";
...
export interface ProductionSession {
  ...
  average_cycle_status: CycleTimeStatus;
  average_cycle_difference_sec: number | null;
...
export interface PieceEvent {
  ...
  operation_type: OperationType | null;
  estimated_cycle_time_sec: number | null;
  cycle_status: CycleTimeStatus;
  cycle_difference_sec: number | null;
...
export interface AnalyticsSummary extends IotMetrics {
  ...
  achievement_percent: number;
  average_cycle_seconds: number | null;
  within_estimate_count: number;
  over_estimate_count: number;
  cycle_compliance_percent: number | null;
}
