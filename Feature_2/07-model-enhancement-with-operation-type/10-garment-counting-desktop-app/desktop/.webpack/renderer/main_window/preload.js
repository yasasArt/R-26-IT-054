...
/* harmony import */ var _overlay_runtime_error_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overlay/runtime-error.js */ "./node_modules/@electron-forge/plugin-webpack/node_modules/webpack-dev-server/client/overlay/runtime-error.js");
/* harmony import */ var _overlay_state_machine_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlay/state-machine.js */ "./node_modules/@electron-forge/plugin-webpack/node_modules/webpack-dev-server/client/overlay/state-machine.js");
/* harmony import */ var _overlay_styles_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./overlay/styles.js */ "./node_modules/@electron-forge/plugin-webpack/node_modules/webpack-dev-server/client/overlay/styles.js");
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return typeof key === "symbol" ? key : String(key); }
...
/* harmony import */ var _shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/ipc-channels */ "./src/shared/ipc-channels.ts");


const desktopApi = {
    getAppInfo: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.appInfo),
    checkReadiness: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.readiness),
    getBackendStatus: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.backendStatus),
    backendRequest: (request) => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.backendRequest, request),
    exportAnalytics: (query) => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.exportAnalytics, query),
    selectValidationVideo: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.selectValidationVideo),
    getLiveStreamUrl: (sessionId) => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.liveStreamUrl, sessionId),
    onBluetoothDevices: (listener) => {
        const receiveDevices = (_event, devices) => {
            listener(devices);
        };
        electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.on(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.iotDiscoveredDevices, receiveDevices);
        return () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.removeListener(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.iotDiscoveredDevices, receiveDevices);
    },
    selectBluetoothDevice: (deviceId) => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.iotSelectDevice, deviceId),
    cancelBluetoothSelection: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.iotCancelSelection),
    syncIotConnection: (input) => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.iotConnection, input),
    submitHardwareEvent: (input) => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.iotHardwareEvent, input),
    minimizeWindow: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.minimizeWindow),
    toggleMaximizeWindow: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.toggleMaximizeWindow),
    closeWindow: () => electron__WEBPACK_IMPORTED_MODULE_0__.ipcRenderer.invoke(_shared_ipc_channels__WEBPACK_IMPORTED_MODULE_1__.IPC_CHANNELS.closeWindow),
};
electron__WEBPACK_IMPORTED_MODULE_0__.contextBridge.exposeInMainWorld("garmentDesktop", desktopApi);
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("41f69b2e7c3e88c39431")
/******/ 	})();
/******/ 	
/******/ 	/* webpack/runtime/hasOwnProperty shorthand */
/******/ 	(() => {
...
/******/ 	(() => {
/******/ 		const inProgress = {};
/******/ 		const dataWebpackPrefix = "garment-counter-desktop:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdategarment_counter_desktop"] = (chunkId, moreModules, runtime) => {
...
/******/ 	let __webpack_exports__ = __webpack_require__("./src/preload/preload.ts");
/******/ 	
/******/ })()
;
